...
3. 双击运行，托盘区会出现网络图标 🌐。
4. 右键托盘图标即可切换代理模式、重载配置或快速打开工作目录。
...
| 菜单项 | 功能 |
|--------|------|
| 📁 **打开工作目录** | 用资源管理器打开 Mihomo 所在文件夹，方便修改配置文件或查看内核日志 |
| **开 系统代理** / **关 系统代理** | 若显示“关 系统代理”，点击后启动内核并设置系统代理；若显示“开 系统代理”，则停止内核并关闭代理 |
| **开 TUN模式** / **关 TUN模式** | 若显示“关 TUN模式”，以管理员权限启动内核（不修改系统代理）；若显示“开 TUN模式”，强制终止内核进程 |
